...
C <- as.matrix(read.table("../pcangsd/pmarinus_36ind_final_393loci.cov"))
e <- eigen(C)
...
pdf("Pmar_virg_PC.pdf",width=4,height=8)
...
### pc virginica
out = read.table("cvir_36ind.52100snp.gt.noNAs.txt",skip=1)
